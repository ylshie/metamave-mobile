import React, { PureComponent, useCallback, createRef, useState } from 'react';
...
XInput = ({refMe, refNext, onChangeValue}) => {
...
class WeSignup extends PureComponent {
  ...
  onPressImport = () => {
    this.props.navigation.navigate('Persona');
  };
  ...
  renderContent = () => {
    ...
    console.log("========================================\n")
    console.log("=========       UPDATE       ===========\n")
    console.log("==== done:", alldone, " correct:", correct, "========\n")
    console.log("========================================\n")
    console.log("========================================\n")
        ...
        <View style={{
          ...
          <View style={{
            ...
            <Text style={{
              ...
              {`你將收到驗證碼透過”簡訊方式 ” 
              code to your phone ` + country + " " + phone}
            </Text>
          </View>
          ...
          <View style={{
            ...
            <XInput refMe={this.ref1} 
                    refNext={this.ref2}
                    onChangeValue={(text)=>this.updateCode({num1: text})}/>
            <XInput refMe={this.ref2} 
                    refNext={this.ref3}
                    onChangeValue={(text)=>this.updateCode({num2: text})}/>
            <XInput refMe={this.ref3} 
                    refNext={this.ref4}
                    onChangeValue={(text)=>this.updateCode({num3: text})}/>
            <XInput refMe={this.ref4} 
                    refNext={this.ref5}
                    onChangeValue={(text)=>this.updateCode({num4: text})}/>
            <XInput refMe={this.ref5} 
                    refNext={this.ref1}
                    onChangeValue={(text)=>this.updateCode({num5: text})}/>
          </View>
          <View style={{
            marginTop: 10,
            marginBottom: 30,
