...
const My2FA = ({
  ...
  */
  const onApply = () => {
    navigation.navigate(Routes.MODAL.ROOT_MODAL_FLOW, {
      screen: Routes.MODAL.WE_2FA_ACTION,
    });
  }
        ...
        <>
          <View style={{
            ...
            <Text style={{
              ...
              請打開Google Authenticator掃描
              QR Code或輸入以下密鑰添加
            </Text>
            <LinearGradient
              colors={['#E4E9F5', '#FFFFFF']}
              style={{
                width: '100%',
                height: 48,
                flexDirection: 'row',
...
export default connect(mapStateToProps, mapDispatchToProps)(My2FA);
