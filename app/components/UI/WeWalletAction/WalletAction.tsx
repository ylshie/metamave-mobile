...
const WalletAction = ({
  ...
  const walletActionDetails: Record<WalletActionType, WalletActionDetail> = {
    ...
    [WalletActionType.WeSend]: {
      title: strings('asset_overview.we_send'),
      description: strings('asset_overview.send_description'),
      disabledDescription: strings('asset_overview.disabled_button.send'),
    },
    [WalletActionType.WeReceive]: {
      title: strings('asset_overview.we_receive'),
      description: strings('asset_overview.send_description'),
      disabledDescription: strings('asset_overview.disabled_button.send'),
    },
    [WalletActionType.WeSwap]: {
      title: strings('asset_overview.we_swap'),
      description: strings('asset_overview.send_description'),
      disabledDescription: strings('asset_overview.disabled_button.send'),
    },
    [WalletActionType.WeCashout]: {
      title: strings('asset_overview.we_cashout'),
      description: strings('asset_overview.send_description'),
      disabledDescription: strings('asset_overview.disabled_button.send'),
    },
    [WalletActionType.WePoint]: {
      title: strings('asset_overview.we_point'),
      description: strings('asset_overview.send_description'),
      disabledDescription: strings('asset_overview.disabled_button.send'),
    },
    [WalletActionType.WeFriend]: {
      title: strings('asset_overview.we_friend'),
      description: strings('asset_overview.send_description'),
      disabledDescription: strings('asset_overview.disabled_button.send'),
    },
    [WalletActionType.WeSocial]: {
      title: strings('asset_overview.we_social'),
      description: strings('asset_overview.send_description'),
      disabledDescription: strings('asset_overview.disabled_button.send'),
    },
    [WalletActionType.WeGame]: {
      title: strings('asset_overview.we_game'),
      description: strings('asset_overview.send_description'),
      disabledDescription: strings('asset_overview.disabled_button.send'),
    },
  };
  ...
  return (
    ...
    >
      ...
      //backgroundColor={colors.primary.default}
        backgroundColor={'transparent'} // [Arthur]
