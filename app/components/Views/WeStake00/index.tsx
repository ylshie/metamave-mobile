...
import { Title, Max, Grid, Row, Key, Value, Stake, Balance, Agreement, NextStep } from './element';
...
const MyPersona = ({
  ...
  const onPressConfirm = async () => {
    ...
    try {
      const res = await wzAddStake(token, 0, stake)
      if (res.ok) {
        navigation.navigate(Routes.MODAL.ROOT_MODAL_FLOW, {
      ...
      >
        ...
        <View style={{
          ...
          <Grid>
            ...
            <Row>
              <Key text='Minimum Staking'/>
              <Value text='10 wPoint'/>
            </Row>
          </Grid>
        </View>
        <View style={{
